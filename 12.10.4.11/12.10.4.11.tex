...
\begin{equation}
 ...
 \end{equation}
\begin{enumerate}
\item Here, $\theta = \frac{\pi}{6}$ \\
$\therefore\norm {\vec{a}}$ $\norm {\vec{b}} sin \theta = 0$\\
\item Here, $\theta = \frac{\pi}{4}$\\
$\therefore\norm {\vec{a}}$ $\norm {\vec{b}} sin \theta = 1$\\
\item Here, $\theta = \frac{\pi}{3}$\\
$\therefore\norm {\vec{a}}$ $\norm {\vec{b}} sin \theta = 0$\\
\item Here, $\theta = \frac{\pi}{2}$\\
$\therefore\norm {\vec{a}}$ $\norm {\vec{b}} sin \theta = 0$\\
\end{enumerate}
Thus, correct option is 2, $\vec{a} \times \vec{b} $ is a unit vector, if the angle between $\vec{a} \ \text{and}\ \vec{b} $ is $\frac{\pi}{4}$
\end{document}
